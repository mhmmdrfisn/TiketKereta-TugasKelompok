...
$query_pemesanan = "SELECT * FROM rincian_pemesanan WHERE id_pengguna = '$id_pengguna' AND status_pembayaran IN ('Lunas', 'Dibatalkan') ORDER BY id_pemesanan DESC";
...
<head>
    ...
    <title>HealingLoko - Riwayat Pesanan Saya</title>
</head>
<style>
    body {
    ...
    <div class="container">
        ...
        <script>
            function printPesanan(id_pemesanan) {
                window.location.href = "struk_riwayat_profile.php?id_pemesanan=" + id_pemesanan;
            }
        </script>
